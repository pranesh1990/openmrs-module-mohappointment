 ...
 * 
 */
public class Attended extends State {
	private MoHAppointment appointment;
	private Log log = LogFactory.getLog(this.getClass());
	private static Attended instance;

	// Constructor
	private Attended(MoHAppointment appointment) {
		System.out.println("Attended State is instantiated...");
	...
	public static State enter(MoHAppointment appointment) {
		if (instance == null)
			instance = new Attended(appointment);
